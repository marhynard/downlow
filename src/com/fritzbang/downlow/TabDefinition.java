...
public abstract class TabDefinition {
	 ...
	 * 
	 * @param inflater
	 *            The {@link LayoutInflater} used to create {@link View}s.
	 * @param tabsView
	 *            The {@link View} that holds the tab {@link View}s.
	 * @return The tab {@link View} that will be placed into the tabs
	 *         {@link ViewGroup}.
	 */
	public abstract View createTabView(LayoutInflater inflater,
			ViewGroup tabsView);
}
