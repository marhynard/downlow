...
public class TabsFragment extends Fragment implements OnTabChangeListener {
	...
	private final TabDefinition[] TAB_DEFINITIONS = new TabDefinition[] {
			...
			new SimpleTabDefinition(R.id.tab_channel, R.layout.simple_tab,
					R.string.tab_title_1, R.id.tabTitle, new ChannelFragment()),
			new SimpleTabDefinition(R.id.tab_new, R.layout.simple_tab,
					R.string.tab_title_2, R.id.tabTitle,
					new NewEpisodeFragment()),
			new SimpleTabDefinition(R.id.tab_player, R.layout.simple_tab,
					R.string.tab_title_3, R.id.tabTitle, new PlayerFragment()),
			new SimpleTabDefinition(R.id.tab_downloads, R.layout.simple_tab,
					R.string.tab_title_4, R.id.tabTitle, new DownloadFragment()), };
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		_viewRoot = inflater.inflate(R.layout.tab_layout, null);
