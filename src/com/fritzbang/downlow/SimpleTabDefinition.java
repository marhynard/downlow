...
public class SimpleTabDefinition extends TabDefinition {
	 ...
	 * 
	 * @param tabContentViewId
	 *            The layout ID of the contents to use when the tab is active.
	 * @param tabLayoutId
	 *            The ID of the layout to use when inflating the tab
	 *            {@link View}.
	 * @param tabTitleResourceId
	 *            The string resource ID for the title of the tab.
	 * @param tabTitleViewId
	 *            The layout ID for the title of the tab.
	 * @param fragment
	 *            The {@link Fragment} used when the tab is active.
	 */
